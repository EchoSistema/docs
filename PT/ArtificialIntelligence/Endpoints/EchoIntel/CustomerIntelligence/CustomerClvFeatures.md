# Inteligência Artificial – Features de CLV
...
Features de CLV utilizando inteligência artificial e machine learning.
...
O sistema usa regression and probabilistic models para predict customer lifetime value.
