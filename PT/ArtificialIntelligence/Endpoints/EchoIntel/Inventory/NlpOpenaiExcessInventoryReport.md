# Inteligência Artificial – Relatório de Excesso de Estoque (NLP)
...
O sistema usa natural language processing (NLP) models para analyze and extract insights from text data.
