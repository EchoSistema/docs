# Inteligência Artificial – Sugestões de Upsell
...
Sugestões de Upsell utilizando sistemas de recomendação baseados em collaborative e content-based filtering.
...
O sistema usa association rules mining and affinity analysis para identify cross-sell and upsell opportunities.
