# Inteligência Artificial – Recomendação de Itens Similares
...
Recomendação de Itens Similares utilizando sistemas de recomendação baseados em collaborative e content-based filtering.
