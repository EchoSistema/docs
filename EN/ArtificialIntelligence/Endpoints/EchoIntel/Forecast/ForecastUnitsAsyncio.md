# Artificial Intelligence – Unit Sales Forecast (Async)

## Endpoint

```
POST /api/v1/ai/echointel/forecast/units-async
```

Asynchronous unit sales forecasting for large datasets with webhook notification support for job completion.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/forecast/units-async"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/forecast/units-async"
headers = {
...
The system employs advanced machine learning and statistical techniques tailored for predictive forecasting and planning:
...
### Playbook 1: Budget planning and financial forecasting
...
### Playbook 3: Revenue and cost projection
...
### Playbook 4: Capacity planning and resource allocation
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:243`
