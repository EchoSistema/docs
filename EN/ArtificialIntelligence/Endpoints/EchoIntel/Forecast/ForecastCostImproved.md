# Artificial Intelligence – Cost Forecast (Improved)
...
Enhanced cost forecasting with advanced ensemble methods, anomaly detection, and multi-horizon predictions.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/forecast/cost-improved"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/forecast/cost-improved"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:240`
