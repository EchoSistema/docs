...
Forecasts aggregated costs across multiple categories, departments, or products with breakdown analysis.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/forecast/cost-totus"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/forecast/cost-totus"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:241`
