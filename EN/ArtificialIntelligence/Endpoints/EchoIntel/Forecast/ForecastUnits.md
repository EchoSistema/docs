# Artificial Intelligence – Unit Sales Forecast
...
Predicts future unit sales volume using statistical and machine learning forecasting algorithms.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/forecast/units"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/forecast/units"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:242`
