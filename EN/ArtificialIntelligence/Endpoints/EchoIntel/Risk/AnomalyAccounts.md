...
Detects anomalous account behavior patterns that may indicate fraud, abuse, or security threats.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/risk/anomaly-accounts"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/risk/anomaly-accounts"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:355`
