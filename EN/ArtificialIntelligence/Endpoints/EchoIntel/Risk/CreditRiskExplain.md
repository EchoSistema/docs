...
```
POST /api/v1/ai/echointel/risk/credit-risk-explain
```

Provides explainable credit risk assessments with feature importance and decision rationale using SHAP values.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/risk/credit-risk-explain"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/risk/credit-risk-explain"
headers = {
...
The system employs advanced machine learning and statistical techniques tailored for risk assessment and fraud detection:
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:358`
