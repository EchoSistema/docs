...
Identifies suspicious transactions using unsupervised learning and statistical anomaly detection methods.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/risk/anomaly-transactions"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/risk/anomaly-transactions"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:357`
