# Inteligencia Artificial – Rotulação de Churn
...
Rotulação de Churn utilizando inteligência artificial y machine learning.
...
El sistema utiliza rule-based classification logic para assign labels to historical data for model training.
