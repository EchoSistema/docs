...
Extracts engineered behavioral, transactional, y demographic features from customer data for machine learning model inputs.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/features"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/features"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:135`
