# Artificial Intelligence – Customer Loyalty Analysis
...
Analyzes customer loyalty metrics y scores using behavioral patterns, purchase history, y engagement data.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/loyalty"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/loyalty"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:152`
