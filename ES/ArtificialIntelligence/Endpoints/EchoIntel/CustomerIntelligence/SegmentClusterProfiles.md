...
```
POST /api/v1/ai/echointel/customer-intelligence/cluster-profiles
```

Provides detailed statistical profiles for each customer segment including demographics, behaviors, y value metrics.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/cluster-profiles"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/cluster-profiles"
headers = {
...
El sistema emplea técnicas avanzadas de aprendizaje automático y estadística adaptadas para inteligencia de clientes y analítica:
...
### Playbook 1: Segmentación de clientes para marketing dirigido
...
### Playbook 2: Prevención de abyono y campañas de retención
...
### Playbook 3: Optimización del valor de vida del cliente
...
### Playbook 4: Experiencias de cliente personalizadas
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:159`
