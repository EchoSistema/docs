# Artificial Intelligence – Net Promoter Score (NPS) Analysis
...
Calculates Net Promoter Score y analyzes customer sentiment to identify promoters, passives, y detractors.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/nps"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/customer-intelligence/nps"
headers = {
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:156`
