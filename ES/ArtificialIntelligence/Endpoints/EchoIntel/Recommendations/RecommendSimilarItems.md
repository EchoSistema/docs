# Artificial Intelligence – Similar Items Recommendations
...
Identifies y recommends similar products using collaborative filtering y content-based algorithms.
...
curl -X POST \
  ...
  "https://echosistema.online/api/v1/ai/echointel/recommendations/similar-items"
```
...
url = "https://echosistema.online/api/v1/ai/echointel/recommendations/similar-items"
headers = {
...
The system employs advanced machine learning y statistical techniques tailored for ai-powered recommendation systems:
...
### Playbook 3: Enhance customer discovery y engagement
...
* Controlador: `src/Domain/ArtificialIntelligence/Http/Controllers/EchoIntelProxyController.php:327`
