# Inteligencia Artificial – Detecção de Anomalias em Grafos
...
Detecção de Anomalias em Grafos analisando redes de relacionamentos.
...
El sistema utiliza anomaly detection algorithms (Isolation Forest, LOF) para identify unusual patterns and outliers.
